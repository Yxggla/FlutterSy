          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text('发现',
                    style: TextStyle(fontSize: 36, color: Color.fromRGBO(198, 101, 56, 1.0))),
              ),
              SizedBox(height: 16),
              Padding(
                padding: EdgeInsets.symmetric(horizontal: 16),
                child: Text('热门',
                    style: TextStyle(fontSize: 24, color: Color.fromRGBO(198, 101, 56, 1.0))),
              ),
              SizedBox(height: 6),
              Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      FilterText(
                          '全部',
                          selectedFilter == '全部'
                              ? TextStyle(fontSize: 22, color: Color.fromRGBO(198, 101, 56, 1.0))
                              : null,
                          () => onFilterSelected('全部')),
                      SizedBox(width: 10),
                      FilterText(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("杭州博物馆",
                            style:
                            TextStyle(
                                fontSize: 16, color: Color.fromRGBO(198, 101, 56, 1.0))),
                        SizedBox(height: 4),
                        Text("宋韵杭博奇妙夜",
                            style:
                            TextStyle(
                                fontSize: 12, color: Color.fromRGBO(198, 101, 56, 1.0))),
                        SizedBox(height: 4),
                        Text("时间:2023.4.2——2023.4.29",
                            style:
                            TextStyle(
                                fontSize: 10, color: Color.fromRGBO(198, 101, 56, 1.0))),
                        SizedBox(height: 4),
                        Text("地点:杭州粮道山",
                            style:
                            TextStyle(
                        ...
                        Row(
                          children: [
                            Icon(Icons.confirmation_number,color: Color.fromRGBO(198, 101, 56, 1.0),size: 20,), // Replace with the desired icon
