              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 20),
                    Padding(
                      padding: EdgeInsets.only(top: 34), // 设置顶部间距
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('爱吃东北肠卷的画卷饼人', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                          Text('账户名：8734792760', style: TextStyle(fontSize: 14)),
                        ],
                      ),
                    ),
                    Spacer(),
                      ...
                      children: [
                        Expanded(
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(10),
                                color: Color.fromRGBO(245, 231, 207, 1)
                            ),
                            child: Center(
                              child: Column(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Text('4时19分',style: TextStyle(fontSize: 20),),
                                  SizedBox(height: 4,),
                                  Text('学习时长'),
                                ],
                              ),
