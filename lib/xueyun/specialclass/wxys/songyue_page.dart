              ...
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(fontSize: 16,height: 1.5,color: Color.fromRGBO(198, 101, 56, 1.0),fontWeight: FontWeight.bold,),
                  ),
                  SizedBox(height: 6),
                  Text(
                    '    宋朝出现了徽、洛、仪、岳四大琴派，同时创立了更加完善的音律体系和乐理学说。此外，宋朝的乐器制作技术也相当精湛，著名的有南音派的编钟和北音派的木鱼等。',
                    style: TextStyle(fontSize: 16,height: 1.5,color: Color.fromRGBO(198, 101, 56, 1.0)),
                  ),
                  SizedBox(height: 6),
                  Text(
                  ...
                  Text(
                    ...
                    style: TextStyle(fontSize: 12,height: 1.5,color: Color.fromRGBO(198, 101, 56, 1.0)),
                  ),
                ],
              ),
            ),
